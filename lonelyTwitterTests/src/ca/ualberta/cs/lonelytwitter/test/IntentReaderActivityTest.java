...
public class IntentReaderActivityTest extends
	...
	public void testSendText() {
		...
		setActivityIntent(intent); // explicitly sets the intent for that
									// activity. or else it would just read the
									// default value from ira.getText()
	...
	public void testDisplayText() {
		...
		setActivityIntent(intent); // inject the intent to the activity
...
//		setActivityIntent(intent); // inject the intent to the activity
		...
		IntentReaderActivity ira = getActivity(); // Dont need intents cuz Activity checking isnt checking the data inside the activbity
		TextView tv = (TextView) ira
				.findViewById(ca.ualberta.cs.lonelytwitter.R.id.intentText);
